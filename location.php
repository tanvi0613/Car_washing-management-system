                    ...
                    <div class="col-lg-12">
                        <div class="section-header text-left">
                            <div class="vertical-line">
                                <h1 class="vertical-line-text"><span style="white-space:nowrap">Washing Points</span></h1>
                                <h1 class="vertical-line-text2"><span style="white-space:nowrap">Washing Points</span></h1>
                            </div>
