            ...
            <div class="container">
                <div class="section-header text-center">
                        <div class="vertical-line">
                            <h1 class="vertical-line-text"><span style="white-space:nowrap">Get In Touch</span></h1>
                            <h1 class="vertical-line-text2"><span style="white-space:nowrap">Get In Touch</span></h1>
                        </div>
